    ...
    <div id="step1">
      <div class="list release">
        ...
        <div class="bot">
          ...
          <div class="middle">
            <van-field v-model="voucherName" placeholder="请填写, 如标准间" />
          </div>
          <div class="right">
      ...
      <div class="list release">
        ...
        <div class="bot bot5">
          ...
          <div class="middle">
            <van-field v-model="costPrice" type="number" placeholder="请填写" />
          </div>
          <div class="right">
            <p>元</p>
          </div>
        ...
        <div class="bot bot5">
          ...
          <div class="middle">
            <van-field v-model="voucherPrice" placeholder="请填写" />
          </div>
          <div class="right">
            <p>元</p>
          </div>
      ...
      <div class="list">
        ...
        <div class="bot bot11">
          ...
          <div class="middle" style="margin-top: 0; width: 3rem; min-width: 3rem;">
            <van-stepper v-model="limitFix" :disabled='isLimit'	integer/>
          </div>
          <div class="right" style="padding: .1rem 0">
            <van-checkbox v-model="isLimit">不限</van-checkbox>
          </div>
        </div>
      </div>
      <div class="blank"></div>
      <div class="list">
        <h3 class="step2-title" style="padding-top: .2rem">使用信息</h3>
         <div class="bot bot11" @click="popShowClick(5)">
          <div class="left">
            <div class="iconfont"></div>
            <p>有效期开始</p>
          </div>
        ...
        <div class="bot bot11" @click="popShowClick(6)">
          <div class="left">
            <div class="iconfont"></div>
            <p>有效期结束</p>
          </div>
        ...
        <div class="bot bot11">
          ...
          <div class="middle">
            <div :class="isBespoke == 1 ?'ischeck btn checkbtn':'btn checkbtn'" @click="bespoke(1)">预约</div>
            <div :class="isBespoke == 0 ?'ischeck btn checkbtn':'btn checkbtn'" @click="bespoke(0)">免预约</div>
          </div>
        </div>
        <div class="bot" v-show="isBespoke == 1">
          <div class="left">
            <div class="iconfont"></div>
            <p>预约时间</p>
          </div>
          <div class="middle">
            <van-field v-model="bespokeTime" placeholder="请填写" />
          </div>
          <div class="right">
            <div class="iconfont"></div>
          </div>
        ...
        <div class="bot bot11">
          ...
          <div class="middle" style="margin-top: 0; width: 3rem; min-width: 3rem;">
            <van-stepper v-model="limitNumber" :disabled='isNumberLimit'/>
          </div>
          <div class="right" style="padding: .1rem 0">
            <van-checkbox v-model="isNumberLimit">不限</van-checkbox>
          </div>
        </div>
        <div class="bot">
          <div class="left">
          ...
          <div class="middle">
            <van-field v-model="unuseTime" placeholder="请填写" />
          </div>
          <div class="right">
            <div class="iconfont"></div>
          </div>
        ...
        <div class="bot">
          ...
          <div class="middle">
            <van-field v-model="useTimeQuantum" placeholder="请填写" />
          </div>
          <div class="right">
            <div class="iconfont"></div>
          </div>
        ...
        <div class="bot">
          ...
          <div class="middle">
            <van-field v-model="scopeTrial" placeholder="请填写" />
          </div>
          <div class="right">
            <div class="iconfont"></div>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      confirm(value){
        ...
        if(this.popType == 5){
          this.usePeriodStart = value.getFullYear() + '-' + (value.getMonth() + 1) + '-' + value.getDate();
        }
        if(this.popType == 6){
          this.usePeriodEnd = value.getFullYear() + '-' + (value.getMonth() + 1) + '-' + value.getDate();
        }
        this.cancel()
      },
      cancel(){
      ...
      submit(){
        ...
        var params = {
          businessId: this.id,
          businessType: 2,
          voucherName: this.voucherName,    //	房间名称	string	
          voucherPrice: this.voucherPrice,    //		挂牌价	number	
          costPrice: this.costPrice,    //		网络预约价	number	
          ...
          isLimit: this.isLimit ? 1 : 0,
          isNumberLimit: this.isNumberLimit ? 1 : 0
        }
        if(this.$route.query.voucherId){
          params.id = this.$route.query.voucherId
        }
        if(this.isLimit){
          params.limitFix = this.limitFix
        }
        ...
        if(this.usePeriodStart && this.usePeriodEnd){
          params.usePeriod = this.usePeriodStart + ',' + this.usePeriodEnd
        }
        this.$http.post('appServiceAccount/addVoucher', params).then(
          res => {
            if (res.msg == 'success') {
              this.$toast(res.info)
              this.$router.back(-1) 
      ...
      getVoucher(id){
        this.$http.post('appServiceAccount/updateVoucherParameter', {id}).then(
        res => {
          if (res.msg == 'success') {
            this.id = res.data.businessId
            this.voucherName = res.data.voucherName
            this.voucherPrice = res.data.voucherPrice
            ...
            this.isLimit = res.data.isLimit ? true : false
            this.isNumberLimit = res.data.isNumberLimit ? true : false
            this.bookingType = res.data.bookingType
            if(res.data.isLimit){
              this.limitFix = res.data.limitFix
            }
            if(res.data.isNumberLimit){
            ...
            if(res.data.usePeriod){
              this.usePeriodStart = res.data.usePeriod.split(',')[0]
              this.usePeriodEnd = res.data.usePeriod.split(',')[1]
            }
          }
        })
      }
    ...
    created(){
      ...
      if(this.$route.query.voucherId){
        this.$route.query.voucherId
        this.title = '修改美食'
        this.getVoucher(this.$route.query.voucherId)
      }
      // this.init()
    },
    mounted(){
