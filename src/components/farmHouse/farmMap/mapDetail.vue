<template>
  <div id="mapDetail">
    ...
    <div class="position clear">
      <div class="left">
        <p>{{detail.flanspacePlaceName}}</p>
        <p class="van-ellipsis">
          <i class="iconfont icon-dizhi"></i>
          {{detail.farmhouseTitle}}
        </p>
      </div>
      <div class="right">
        <a target="_self" :href="'https://uri.amap.com/marker?position='+detail.longitude+','+detail.latitude+'&name='+(detail.flanspacePlaceName)+''">
...
<script>
  ...
  import methods from './methods/mapDetail'
