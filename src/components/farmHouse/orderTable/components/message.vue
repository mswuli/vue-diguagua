  ...
  <div>
    <div class="message">
      ...
      <div class="content">
        ...
        <div class="require">
          <div class="left">
            <p style="margin-left: 0.4rem">看房要求</p>
          </div>
          <div class="middle">
        ...
        <div class="agreement">
          <van-checkbox v-model="checked" checked-color="#4b0" style="display: inline-block; vertical-align: middle;">
            我已同意武汉三乡工程网
          </van-checkbox><router-link :to="{name:'agreement',query:{pid: 2}}" style="vertical-align: middle;" class="aa">《预约看房使用协议》</router-link>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      order() {
        ...
        // var hour =14
        // 输入框天
        var inDay=parseInt((this.date).slice(8))
        // 输入框小时
        var inHour=parseInt((this.time).slice(9,11))
        var allDay=this.time
                        ...
                        if(day<inDay){
                          ...
                          if(hour<inHour){
                            if(inHour<=18){
                              ...
                              this.$toast("预约时间不能大于当前时间")
                            }
                          }else{
                            this.$toast("预约时间不能小于当前时间")
                          }
                        }
                        if(allDay=="全天可看"){
                          if (res.info == '添加成功') {
